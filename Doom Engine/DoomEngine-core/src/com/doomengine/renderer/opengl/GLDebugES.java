...
public class GLDebugES extends GLDebug implements GL, GLExt, GLFbo {
	...
	@Override public void glCompressedTexImage2D(int target, int level, int internalformat, int width, int height, int border, ByteBuffer data) {
	...
	@Override public int glCreateShader(int shaderType) {
	...
	@Override public void glDepthRange(double nearVal, double farVal) {
	...
	@Override public void glGetBoolean(int pname, ByteBuffer params) {
	...
	@Override public void glGetInteger(int pname, IntBuffer params) {
		gl.glGetInteger(pname, params);
		checkError();
	}

	@Override public void glGetProgram(int program, int pname, IntBuffer params) {
	...
	@Override public void glGetShader(int shader, int pname, IntBuffer params) {
	...
	@Override public void glReadPixels(int x, int y, int width, int height, int format, int type, ByteBuffer data) {
		gl.glReadPixels(x, y, width, height, format, type, data);
		checkError();
	}

	@Override public void glReadPixels(int x, int y, int width, int height, int format, int type, long offset) {
	...
	@Override public void glShaderSource(int shader, String[] string, IntBuffer length) {
	...
	@Override public void glTexImage2D(int target, int level, int internalFormat, int width, int height, int border, int format, int type, ByteBuffer data) {
	...
	@Override public void glTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format, int type, ByteBuffer data) {
		gl.glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, data);
		checkError();
	}

	@Override public void glUniform1(int location, FloatBuffer value) {
		gl.glUniform1(location, value);
		checkError();
	}

	@Override public void glUniform1(int location, IntBuffer value) {
		gl.glUniform1(location, value);
		checkError();
	}
	...
	@Override public void glUniform2(int location, IntBuffer value) {
		gl.glUniform2(location, value);
		checkError();
	}

	@Override public void glUniform2(int location, FloatBuffer value) {
		gl.glUniform2(location, value);
		checkError();
	}
	...
	@Override public void glUniform3(int location, IntBuffer value) {
		gl.glUniform3(location, value);
		checkError();
	}

	@Override public void glUniform3(int location, FloatBuffer value) {
		gl.glUniform3(location, value);
		checkError();
	}
	...
	@Override public void glUniform4(int location, FloatBuffer value) {
		gl.glUniform4(location, value);
		checkError();
	}

	@Override public void glUniform4(int location, IntBuffer value) {
		gl.glUniform4(location, value);
		checkError();
	}
	...
	@Override public void glUniformMatrix3(int location, boolean transpose, FloatBuffer value) {
		gl.glUniformMatrix3(location, transpose, value);
		checkError();
	}

	@Override public void glUniformMatrix4(int location, boolean transpose, FloatBuffer value) {
	...
	@Override public void glBufferData(int target, long data_size, int usage) {
	...
	@Override public void glDrawArraysInstancedARB(int mode, int first, int count, int primcount) {
	...
	@Override public void glDrawElementsInstancedARB(int mode, int indices_count, int type, long indices_buffer_offset, int primcount) {
		glext.glDrawElementsInstancedARB(mode, indices_count, type, indices_buffer_offset, primcount);
		checkError();
	}

	@Override public void glGetMultisample(int pname, int index, FloatBuffer val) {
	...
	@Override public void glVertexAttribDivisorARB(int index, int divisor) {
		glext.glVertexAttribDivisorARB(index, divisor);
		checkError();
	}

	@Override public int glClientWaitSync(Object sync, int flags, long timeout) {
		int result = glext.glClientWaitSync(sync, flags, timeout);
		checkError();
		return result;
	}

	@Override public void glDeleteSync(Object sync) {
		glext.glDeleteSync(sync);
		checkError();
	}

	@Override public Object glFenceSync(int condition, int flags) {
