...
public enum Caps {
	...
	/**
	 * Supports {@link Format#ETC1} texture compression by uploading the texture
	 * as ETC2 (they are backwards compatible).
	 */
	...
	/**
	 * Partial support for non-power-of-2 textures, typically found on OpenGL ES
	 * 2 devices.
	 * <p>
	 * Use of NPOT textures is allowed if:
	 * <ul>
	...
	/**
	 * Returns true if given the renderer capabilities, the texture can be
	 * supported by the renderer.
	 * <p>
	 * This only checks the format of the texture, non-power-of-2 textures are
	 * scaled automatically inside the renderer if are not supported natively.
	 * 
	 * @param caps
	 *            The collection of renderer capabilities
	 *            {@link Renderer#getCaps() }.
	 * @param tex
	...
	//
	// /**
	// * Returns true if given the renderer capabilities, the framebuffer can be
	// * supported by the renderer.
	// *
	// * @param caps
	// * The collection of renderer capabilities
	...
	// return false;
	// } else {
	// if (depthFmt == Format.Depth32F && !caps.contains(Caps.FloatDepthBuffer))
	// return false;
	//
	...
	//
	// /**
	// * Returns true if given the renderer capabilities, the shader can be
	// * supported by the renderer.
	// *
	// * @param caps
	// * The collection of renderer capabilities
