...
void main() {
	...
	if (tid == 0)
		...
		color *= texture2D(texture9, v_texCoord);
	else if (tid == 10)
		color *= texture2D(texture10, v_texCoord);
	else if (tid == 11)
		color *= texture2D(texture11, v_texCoord);
	else if (tid == 12)
		color *= texture2D(texture12, v_texCoord);
	else if (tid == 13)
		color *= texture2D(texture13, v_texCoord);
	else if (tid == 14)
		color *= texture2D(texture14, v_texCoord);
	else if (tid == 15)
		color *= texture2D(texture15, v_texCoord);
