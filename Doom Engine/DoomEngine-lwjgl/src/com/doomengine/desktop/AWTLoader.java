package com.doomengine.desktop;
...
public class AWTLoader implements AssetLoader {
	...
	public Image load(BufferedImage img, boolean flipY) {
		...
		case BufferedImage.TYPE_4BYTE_ABGR: // most common in PNG images w/
			...
			data1.put(dataBuf1);
			return new Image(Format.ABGR8, width, height, data1, ColorSpace.sRGB);
		case BufferedImage.TYPE_3BYTE_BGR: // most common in JPEG images
			...
			data2.put(dataBuf2);
			return new Image(Format.BGR8, width, height, data2, ColorSpace.sRGB);
		case BufferedImage.TYPE_BYTE_GRAY: // grayscale fonts
			...
			data3.put(dataBuf3);
			return new Image(Format.Luminance8, width, height, data3, ColorSpace.sRGB);
		default:
			break;
		}
		...
		if (img.getTransparency() == Transparency.OPAQUE) {
			...
			data.flip();
			return new Image(Format.RGB8, width, height, data, ColorSpace.sRGB);
		} else {
			...
			data.flip();
			return new Image(Format.RGBA8, width, height, data, ColorSpace.sRGB);
		}
	}
